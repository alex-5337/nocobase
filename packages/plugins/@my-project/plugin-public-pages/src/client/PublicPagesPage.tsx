  ...
  const handleSave = async () => {
    ...
    try {
      if (editing) {
        ...
        await api.request({ url: 'publicPages:create', method: 'post', data: values });
      }
  ...
  const columns = [
    {
      ...
      dataIndex: 'slug',
      key: 'slug',
      render: (slug: string) => <Typography.Text copyable={{ text: getPageUrl(slug) }}>{slug}</Typography.Text>,
    },
    {
      title: t('Title'),
      dataIndex: 'title',
